...
<body>
    <h1>__TITLE__</h1>
    <p><a href="__RESTART_URL__" style="display:inline-block;padding:8px 12px;border:1px solid #c7d2e0;border-radius:10px;background:#eef3f8;color:#1f2937;text-decoration:none;font-weight:600;">Парсить заново</a></p>
...
"""
    ...
    return (
        ...
        .replace("__RESTART_URL__", html.escape(restart_url, quote=True))
